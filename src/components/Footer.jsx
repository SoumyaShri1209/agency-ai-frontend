...
const Footer = ({theme}) => {
  return (
    ...
    viewport={{once:true}}
     className='bg-slate-200 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40' >
        {/* footer top */}
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            viewport={{once:true}}
             className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <ul className='flex gap-8'>
                    ...
                    <li><a className='hover:text-blue-600' href="#our-work">Our Work</a></li>
                    <li><a className='hover:text-blue-600' href="#contact-us">Contact Us</a></li>
            ...
            <motion.div 
                ...
                <div className='flex gap-2 text-sm'>
                    ...
                    <button className='bg-blue-600 hover:bg-blue-700 text-white rounded px-6' >Subscribe</button>
                </div>
        ...
        <hr className='border-gray-300 dark:border-gray-600 my-6'/>
         ...
         className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            <p>Copyright 2025 &copy; Soumya Shri - All Right Reserved. </p>
