...
const Hero = () => {
  return (
    <div id='Hero' className='flex flex-col items-center gap-6 py-20  px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white '>
         ...
         viewport={{once:true}}
         className='inline-flex items-center gap-2 p-1.5 border border-gray-300 pr-4 rounded-full'>
         ...
         viewport={{once:true}}
          className='text-sm sm:text-large font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.</motion.p>
         ...
         viewport={{once:true}}
          className='relative'>
            <img className='w-full max-w-6xl ' src={assets.hero_img} alt="hero img" />
